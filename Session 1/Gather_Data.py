...
def gather_20newsgroups_data():
    path = 'D:/DSLab/DSLab_Training_Phase1/Dataset/20news-bydate/'
    ...
    with open('D:/DSLab/DSLab_Training_Phase1/Dataset/20news-bydate/stop_words.txt') as f:
    ...
    with open('D:/DSLab/DSLab_Training_Phase1/Dataset/20news-bydate/20news-train-processed.txt', 'w') as f:
        f.write('\n'.join(train_data))
    with open('D:/DSLab/DSLab_Training_Phase1/Dataset/20news-bydate/20news-test-processed.txt', 'w') as f:
        f.write('\n'.join(test_data))
    with open('D:/DSLab/DSLab_Training_Phase1/Dataset/20news-bydate/20news-full-processed.txt', 'w') as f:
        f.write('\n'.join(full_data))
